      ...
      <div className="grid grid-cols-3 w-full text-white mt-6">
        <div className="w-full">
          ...
          <ul className="flex flex-col list-none mt-1">
            <li>
              <Link href="/" className="text-white font-normal">Domů</Link>
            </li>
            <li>
              <Link href="/produkty" className="text-white font-normal">Produkty</Link>
            </li>
            <li>
              <Link href="/kontakt" className="text-white font-normal">Kontakt</Link>
            </li>
          </ul>
        </div>
        <div className="w-full">
          ...
          <p className="text-xl mt-2">
            Email:
            <a href="mailto:dan@dcreative.cz" className="text-white text-base">dan@dcreative.cz</a>
          </p>
          <p className="text-xl mt-2">
            Telefon:
            <a href="tel:+420 777 777 777" className="text-white text-base">+420 777 777 777</a>
          </p>
          <p className='text-xl mt-2'>
            Adresa:
            <a href="https://maps.app.goo.gl/bQZYMVXWX2y72uwK8" target="_blank" rel="noopener noreferrer" className="text-white text-base">
